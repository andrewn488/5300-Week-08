...
ANSWER HERE: What it does to the estimate is it will cause it to appear smaller than what it really is. This would be called the Intent To Treat (ITT) estimate 

Compliance issue - even though letters have been sent, water usage may not have changed. 
...
ANSWER HERE: What I might have done differently would be to trim the observations to tamp down the skewedness. 
...
ANSWER HERE: Power will likely be low powered. We wouldn't have enough people to see the effect since we'd need 16x 34,000 observations. 
